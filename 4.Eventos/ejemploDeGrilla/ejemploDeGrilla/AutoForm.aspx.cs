    ...
    public partial class AutoForm : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    /// Para buscar el auto seleccionado usando lambda expression
        ...
        protected void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionado != null)
            {
                ...
                seleccionado.Fecha = DateTime.TryParse(txtFecha.Text, out DateTime parsedDate) ? parsedDate : DateTime.Now;
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionado != null)
            {
                ((List<Auto>)Session["listaAutos"]).Remove(seleccionado);
                Response.Redirect("Default.aspx");
            }
        }
    }
